...
import iconAbjuration from '~/assets/images/abjuration.svg?no-inline'
import iconConjuration from '~/assets/images/conjuration.svg?no-inline'
import iconDivination from '~/assets/images/divination.svg?no-inline'
import iconEnchantment from '~/assets/images/enchantment.svg?no-inline'
import iconEvocation from '~/assets/images/evocation.svg?no-inline'
import iconIllusion from '~/assets/images/illusion.svg?no-inline'
import iconNecromancy from '~/assets/images/necromancy.svg?no-inline'
import iconTransmutation from '~/assets/images/transmutation.svg?no-inline'
